...
plt.show() # Ensure the 1st plot is displayed

df[outlier_columns[:3] + ["label"]].boxplot(by="label", figsize=(20,10), layout=(1,3))
plt.show() # Display acc data
df[outlier_columns[3:] + ["label"]].boxplot(by="label", figsize=(20,10), layout=(1,3))
plt.show() # Display gyr data
...
for col in outlier_columns:
    ...
    ) # This produced way more outliers compared to the tutorial
